...
//       filterSubscriptionsByDateRange(subs, dateRange);
//     } catch (error) {
//       throw error;
//     } finally {
//       setLoading(false);
...
//   const filterSubscriptionsByDateRange = (data: Payment[], range: { from: Date; to: Date }) => {
//     const filtered = data.filter(sub => {
//       const subDate = new Date(sub.dateCreated);
//       return subDate >= range.from && subDate <= range.to;
//     });
...
//   useEffect(() => {
//     filterSubscriptionsByDateRange(subscriptions, dateRange);
...
//     const finalFiltered = filtered.filter(sub => {
//       return Object.entries(selectedFilters).every(([key, value]) => 
//         value === 'all' || sub[key as keyof Payment] === value
//       );
//     });

//     setFilteredSubscriptions(finalFiltered);
//   }
...
//             <BreadcrumbNav items={breadcrumbItems} />
//           </div>
//           <div className="flex flex-col justify-items-end gap-0 mb-3">
//             <p>Apply Filters</p>
...
//               data={filteredSubscriptions}
//               searchKey="locationName"
//               // No need to pass filters here anymore
//             />
//           </CardContent>
//         </Card>
//       </div>
