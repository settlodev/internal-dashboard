...
const LocationDetailClient = ({ location, payments, activeSubscription, statistics, activityLogs }: { location: any; payments: any; activeSubscription: ActiveSubscription | null , statistics: any, activityLogs: any}) => {
  ...
  <Card>
    <CardHeader>
      {/* Header - Location Info + Subscription */}
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <div>
            <CardTitle className="text-xl sm:text-2xl">Subscription status</CardTitle>
            <div className="flex flex-wrap gap-2 mt-2">
              <Badge variant={statusBadge.variant as 'default' | 'destructive' | 'outline' | 'secondary'}>
                {statusBadge.text}
              </Badge>
