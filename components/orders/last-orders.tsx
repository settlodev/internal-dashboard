...
// export function BusinessOwnersWithLastOrdersPlacedInXDays({ 
...
//     setIsLoading(true)
//     try {
//       const data = await businessOwnersWithLastOrderPlacedInXDays(page, size, dateRange.from, dateRange.to)
...
//               The list of customers who have not placed order in x days.
...
import { DatePickerWithRange } from '@/components/widgets/date-range-picker'
import { Owner } from '@/types/owners/type'
import { businessOwnersWithLastOrderPlacedInXDays, subscriptionExpiresInXDays } from '@/lib/actions/business-owners'
import { columns } from '../table/no-orders/column'
